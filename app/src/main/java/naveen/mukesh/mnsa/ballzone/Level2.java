...
public class Level2 extends Activity implements SensorEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sm.registerListener(Level2.this,s,SensorManager.SENSOR_DELAY_NORMAL);
		...
		PowerManager pw=(PowerManager) getSystemService(POWER_SERVICE);
		 ...
		 mp1=MediaPlayer.create(Level2.this,R.raw.flourish );
		mp1.start();
		r1=new Rect();
		r2=new Rect();
		mp=MediaPlayer.create(Level2.this, R.raw.bomb);
		mp.setLooping(false);
	...
	//iv1.getResources();
	 iv1.getHitRect(r1);
		...
		if(Rect.intersects(r1, r2)&&cmp){
			mp.start();
		sm.unregisterListener(Level2.this);
			Level2.this.finish();
		}
