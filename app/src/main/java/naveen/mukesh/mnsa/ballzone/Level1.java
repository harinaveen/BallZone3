...
public class Level1 extends Activity implements SensorEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sm.registerListener(Level1.this,s,SensorManager.SENSOR_DELAY_NORMAL);
		...
		r1=new Rect();
		r2=new Rect();
		mp=MediaPlayer.create(Level1.this, R.raw.bomb);
		mp1=MediaPlayer.create(Level1.this,R.raw.flourish );
		mp.setLooping(false);
	...
	//iv1.getResources();
	 iv1.getHitRect(r1);
		...
		if(Rect.intersects(r1, r2)&&cmp){
			mp.start();
		sm.unregisterListener(Level1.this);
			Level1.this.finish();
		}
